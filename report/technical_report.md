...
### 6.2 Profiling
- **Latency:** mean and 95th-percentile of 30 timed forward passes
...
| model           |   num_params_m |   model_size_mb |   latency_ms |   p95_latency_ms |   throughput_ips |   memory_mb |   energy_mj |   accuracy |
|:----------------|---------------:|----------------:|-------------:|-----------------:|-----------------:|------------:|------------:|-----------:|
| MobileViT-S     |           4.94 |           18.86 |        97.91 |           115.25 |            10.21 |        0.2  |     770.22  |      0.124 |
| EfficientViT-B0 |           2.14 |            8.16 |        31.37 |            44.56 |            31.88 |        0.02 |     493.724 |      0.11  |
| TinyViT-5M      |           5.07 |           19.36 |        80.77 |            88.97 |            12.38 |        0.01 |     682.317 |      0.128 |
| DeiT-Tiny       |           5.53 |           21.08 |        39.99 |            51.46 |            25.01 |        0    |     284.841 |      0.119 |

### 9.2 Plots
![Latency vs Accuracy](../outputs/plots/latency_vs_accuracy.png)
![Memory vs Accuracy](../outputs/plots/memory_vs_accuracy.png)
![Energy vs Accuracy](../outputs/plots/energy_vs_accuracy.png)
![Pareto Frontier](../outputs/plots/pareto_frontier.png)

### 9.3 Pareto-Optimal Set
`EfficientViT-B0`, `TinyViT-5M`, `DeiT-Tiny`
